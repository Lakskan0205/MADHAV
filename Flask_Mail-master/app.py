...
app.config['MAIL_PASSWORD']='nxgknupghjjodabq'                    #you have to give your password of gmail account
...
def verify():
    ...
    msg=Message(subject='OTP',sender='hackjacks@gmail.com',recipients=[email])
